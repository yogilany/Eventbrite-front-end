...
const LoginForgotPasswordModal = (props) => {
    return (
        ...
        >
            ...
            <Modal.Body >
                <Container fluid className="text-center justify-content-center d-flex pb-5 pt-5 ">
                    <Col md={2}></Col>
                    <Col md={8}>
                        <Row className='mb-3'>
                        ...
                        <Row>
                            <h2 className='verify-modal-header'>Check your email to update <br></br>your password</h2>
                        </Row>
                        <Row>
                        ...
                        <Row>
                            <span style={{ color: "#6f7287" }}>
                                <p><HiIcons.HiOutlineClock
                                    size={20}
                                    style={{ marginRight:"0.3rem",color: "#6f7287" }} />{"For your security, the link expires in 15 minutes"}</p>
                            </span>
                        </Row>
                    </Col>
                    <Col md={2}></Col>
