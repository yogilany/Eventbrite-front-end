...
const SearchPage = ({ toggle, location }) => {
  ...
  return (
    <Container fluid className="search-page p-5">
      <button onClick={() => toggle(false)} type="button" class="absolute right-12 text-white bg-gray-400 hover:bg-gray-500 focus:ring-0 focus:outline-none  font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center mr-2 ">
      <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <Row className="p-5">
        <Col className="p-5">
          <div className="grid grid-cols-2 gap-4">
            ...
            <svg class="w-12 h-12 text-gray-600 mr-4"  fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  <path clipRule="evenodd" fillRule="evenodd" d="M9 3.5a5.5 5.5 0 100 11 5.5 5.5 0 000-11zM2 9a7 7 0 1112.452 4.391l3.328 3.329a.75.75 0 11-1.06 1.06l-3.329-3.328A7 7 0 012 9z" />
            ...
            <input
                    ...
                    <svg  class="w-12 h-12 text-gray-600" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
