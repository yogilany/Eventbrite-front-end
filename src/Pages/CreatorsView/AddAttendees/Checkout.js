            ...
            {!isTimeOut ? (
              <div className="grid grid-cols-3">
                          ...
                          >
                            <Row className="mb-3 overflow-scroll">
                              ...
                              >
                                ...
                                {
                                  tickets.map((ticketType, key) => { return <AddAttendeesList ticketType={ticketType} order_id={orderID} /> })                            
                                }
                              </Form.Group>
                            </Row>
                          </Container>
                ...
                <div className="bg-gray-100 p-0 ocl-span-1 ">
                  <img
                    src={img_url ? img_url : "https://images.pexels.com/photos/16760200/pexels-photo-16760200.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"}
                    alt="Your Image"
