...
const Description = () => {
  ...
  return (
    <div className="description__container" data-testid = "descriptionContainer">
      ...
      {addText && <div className='add__text'><textarea data-testid="textArea" id="AddText" onChange={(e) => { setDescriptionValue(e.target.value); e.target.value === "" ? setShowSubmit(false) : setShowSubmit(true)}} /><button onClick = {() => setText(!addText)}><MdDelete /></button></div>}
